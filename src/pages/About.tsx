...
const promises = [
  { icon: Shield, title: 'Transparency', description: 'Clear pricing with no hidden fees. What we quote is what you pay.' },
  { icon: MessageSquare, title: 'Punctual Communication', description: 'Timely responses and updates throughout your booking journey.' },
  { icon: Users, title: 'Curated Partners', description: 'We work only with trusted hotels, airlines, and local operators.' },
  { icon: Heart, title: 'Reliable Support', description: "24/7 assistance from booking to return – we're always a call away." },
];

const values = [
  { icon: Globe, title: 'Passion for Travel', description: 'We believe every journey should be extraordinary.' },
  { icon: Star, title: 'Personalized Service', description: 'No cookie-cutter packages – every itinerary is tailored to you.' },
  { icon: Users, title: 'Seamless Planning', description: 'We handle every detail so you can focus on the experience.' },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Rushtrek Travelling is your gateway to unforgettable international travel experiences. As part of the Rushtrek Tours family, we bring years of expertise in curating exceptional journeys.
                </p>
                <p>
                  From luxurious beach escapes in the Maldives to vibrant city adventures in Dubai, from cultural immersions in Turkey to family-friendly getaways in Bali – we plan every detail with precision and care.
                </p>
                <p>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div
                key={value.title}
                className="text-center p-8 bg-card rounded-2xl shadow-sm border border-border"
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {promises.map((promise, index) => (
              <div
                key={promise.title}
                className="p-6 bg-card rounded-2xl shadow-sm border border-border group hover:border-primary/30 transition-colors"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
