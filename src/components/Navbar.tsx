      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            <a href="tel:+255746772277" className="hidden md:flex items-center gap-2 text-sm font-medium text-foreground hover:text-primary transition-colors">
        ...
        {isOpen && <div className="lg:hidden py-4 border-t border-border animate-fade-in">
            <div className="flex flex-col gap-1">
              ...
              <div className="mt-4 pt-4 border-t border-border">
                <a href="tel:+255746772277" className="flex items-center gap-2 px-4 py-3 text-foreground">
